...
/**
 * “енедерное предложение (предложение на совместную закупку)
 * 
 * @author ќдиссей
 *
 */
public class Proposal extends BasicEntity {
	...
	private LocalDate dueDate;// срок окончани€ приема за€вок
	private CatItem measure;
	private String status = ProposalStatus.INIT.getMessageKey(); // »з набора TenderStatus
	...
	/**
	 * »сключительно дл€ отладки
	 * 
	 * @param id         - уникальный id дл€ таблицы
	 * @param item       - название товара на избранном €зыке
	 * @param categories - категори€ из справочника
	 * @param region     - регион из справочника
	 * @param author     - инициатор тендера, Person
	 * @param i          - максимальна€ цена, по которой участник приобретет товар
	 * @param dueDate    - дата завершени€ тендера
	 */
